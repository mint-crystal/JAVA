...
//		mv.printResult(result, "정보 삭제");
	...
	public void allListMember() {
		Member mb = null;
		mv.allListMember(md.allListMember(mb));
	}
...
//		mv.searchMemberId(mb);
	...
	public void searchMemberName() {
		...
		mv.searchMemberName(md.searchMemberName(mv.inputName()));
